...
volatile unsigned int *EPU_FULL         = (int *)0x00100004;
...
unsigned int _epu_raw_file_start       = 0x00100008;      // read raw file dest start
        ...
        for (int macro_block_pos_y = 0; macro_block_pos_y < macro_y_num; macro_block_pos_y +=1 )
        {
            ...
            for (int macro_block_pos_x = 0; macro_block_pos_x < macro_x_num; macro_block_pos_x +=1)
            {
                ...
                *DMA_en = 0;
                ...
                // 計算下個address
                *DMA_src_addr_temp  = *DMA_src_addr_temp + (int)(words_num_per_MB*4); //DRAM
                //*DMA_dest_addr_temp = *DMA_dest_addr_temp ;//EPU
