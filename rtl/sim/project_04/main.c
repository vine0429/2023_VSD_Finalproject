...
const unsigned int RAW_file_width  = 640; //frame width
const unsigned int RAW_file_height = 480; //frame height
const unsigned int RAW_file_frames = 2;   //encode frame number
