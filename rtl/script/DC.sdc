...
create_clock -name cpu_clk  -period 6.0   [get_ports cpu_clk]
...
set_clock_groups -asynchronous -group {cpu_clk} -group {axi_clk} -group {rom_clk} -group {dram_clk} -group {sram_clk} -group {epu_clk} -group {dma_clk}

set_dont_touch_network      [all_clocks]
set_fix_hold                [all_clocks]
set_clock_uncertainty  0.1  [all_clocks]
set_clock_latency      1.0  [all_clocks]
set_ideal_network           [get_ports {cpu_clk axi_clk rom_clk dram_clk sram_clk epu_clk dma_clk}]

###REMEMBER TO SET THIS MAX DELAY TO 1/2 CLK PERIOD#####
# cpu_clk
set_input_delay  -max 3.0  -clock cpu_clk [remove_from_collection [all_inputs] [get_ports {cpu_clk}]]
set_input_delay  -min 0.0  -clock cpu_clk [remove_from_collection [all_inputs] [get_ports {cpu_clk}]]
set_output_delay -max 3.0  -clock cpu_clk [all_outputs]
set_output_delay -min 0.0  -clock cpu_clk [all_outputs]

# axi_clk
set_input_delay  -max 3.0 -clock axi_clk [remove_from_collection [all_inputs] [get_ports {axi_clk}]]
set_input_delay  -min 0.0 -clock axi_clk [remove_from_collection [all_inputs] [get_ports {axi_clk}]]
set_output_delay -max 3.0 -clock axi_clk [all_outputs]
set_output_delay -min 0.0 -clock axi_clk [all_outputs]

# sram_clk
set_input_delay  -max 3.0 -clock sram_clk [remove_from_collection [all_inputs] [get_ports {sram_clk}]]
set_input_delay  -min 0.0 -clock sram_clk [remove_from_collection [all_inputs] [get_ports {sram_clk}]]
set_output_delay -max 3.0 -clock sram_clk [all_outputs]
set_output_delay -min 0.0 -clock sram_clk [all_outputs]

# rom_clk
set_input_delay  -max 3.0 -clock rom_clk [remove_from_collection [all_inputs] [get_ports {rom_clk}]]
set_input_delay  -min 0.0 -clock rom_clk [remove_from_collection [all_inputs] [get_ports {rom_clk}]]
set_output_delay -max 3.0 -clock rom_clk [all_outputs]
set_output_delay -min 0.0 -clock rom_clk [all_outputs]

# dram_clk
set_input_delay  -max 3.0 -clock dram_clk [remove_from_collection [all_inputs] [get_ports {dram_clk}]]
set_input_delay  -min 0.0 -clock dram_clk [remove_from_collection [all_inputs] [get_ports {dram_clk}]]
set_output_delay -max 3.0 -clock dram_clk [all_outputs]
set_output_delay -min 0.0 -clock dram_clk [all_outputs]

# epu_clk
set_input_delay  -max 3.0 -clock epu_clk [remove_from_collection [all_inputs] [get_ports {epu_clk}]]
set_input_delay  -min 0.0 -clock epu_clk [remove_from_collection [all_inputs] [get_ports {epu_clk}]]
set_output_delay -max 3.0 -clock epu_clk [all_outputs]
set_output_delay -min 0.0 -clock epu_clk [all_outputs]

# dma_clk
set_input_delay  -max 3.0 -clock dma_clk [remove_from_collection [all_inputs] [get_ports {dma_clk}]]
set_input_delay  -min 0.0 -clock dma_clk [remove_from_collection [all_inputs] [get_ports {dma_clk}]]
set_output_delay -max 3.0 -clock dma_clk [all_outputs]
